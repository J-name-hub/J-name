...
def main():
    ...
    st.markdown(f"<h1 style='text-align: center;'>{year}년 {month}월 교대근무 달력</h1>", unsafe_allow_html=True)
    ...
    <div class="calendar-container">
        <div class="calendar-header">교대근무 달력</div>
